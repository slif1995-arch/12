...
## Этап 2: Экран выбора кассира (В разработке)
- [ ] Создание таблицы сотрудников в базе данных
- [ ] Создание таблицы смен
- [ ] Разработка экрана выбора кассира
- [ ] Реализация модального окна для ввода начальной суммы
- [ ] Логика открытия смены
- [ ] Проверка на существующую открытую смену
- [ ] Валидация начальной суммы (неотрицательная)

## Этап 3: Экран кассира
- [ ] Создание таблиц категорий и подкатегорий
- [ ] Разработка экрана кассира с фильтрацией по категориям
- [ ] Реализация поиска товаров
- [ ] Добавление товаров в корзину
- [ ] Отображение товаров по категориям и подкатегориям
- [ ] **Кнопка "Расходы"**
- [ ] **Кнопка "История заказов"**

## Этап 4: История заказов для кассира
### В экране кассира:
- [ ] **Кнопка "История заказов"**
- [ ] Отображение заказов **только за текущую смену**
- [ ] Список заказов с датой, временем, суммой
- [ ] **Возможность отмены заказа** (если заказ не оплачен)
- [ ] **Маркировка отмененных заказов** (не удаление, а статус "Отменен")
- [ ] Фильтрация заказов по статусу (оплаченные, отмененные, в работе)

## Этап 5: Модальное окно расходов
### При нажатии на кнопку "Расходы":
- [ ] **Выбор категории расходов** из списка (из админ панели)
- [ ] **Выбор способа оплаты:** Наличные / Перевод
- [ ] **Ввод суммы расхода**
- [ ] **Поле для комментариев** (необязательно)
- [ ] **Валидация суммы** (неотрицательная)
- [ ] **Сохранение расхода** в текущую смену с указанием типа оплаты

## Этап 6: Улучшение корзины
- [ ] Возможность удаления товаров из корзины
- [ ] Добавление комментариев к товарам
- [ ] Редактирование количества товаров
- [ ] Модальное окно для редактирования товара в корзине

## Этап 7: Окно оплаты
- [ ] **Выбор способа оплаты:** Наличные / Перевод
- [ ] **Выбор скидки:** 10% / 50% (только фиксированные значения)
- [ ] **Выбор категории заказа:** ЗАЛ / ДОСТАВКА / САМОВЫВОЗ
- [ ] Отображение итоговой суммы с учетом скидки
- [ ] Логика расчета сдачи для наличных
- [ ] Сохранение типа заказа в базе данных
