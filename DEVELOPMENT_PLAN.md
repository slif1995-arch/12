...
## Этап 9: Закрытие смены (✅ Завершено)
### Модальное окно закрытия смены:
- [x] **Ввод сумм по категориям:**
  - "Остаток"
  - "Терминал" 
  - "Бензин"
  - "Касса"
- [x] **Выбор сотрудников для выплаты ЗП**
- [x] Отображение итоговой суммы для выплаты
- [x] Сохранение данных закрытия смены

### Отчет закрытия смены:
- [x] **"Дата"** - дата закрытия смены
- [x] **"Касса"** - вводится в модульном окне
- [x] **"Выручка"** - оплата переводом + наличные
- [x] **"Без|Нал"** - все что оплачивалось картой
- [x] **"Терминал"** - вводится в окне
- [x] **"Бензин"** - вводится в окне
- [x] **"Зарплата"** - выбирается в окне
- [x] **"Расход безнал"** - весь расход, оплаченный переводом, расписанный по категориям
- [x] **"Расход нал"** - весь расход, оплаченный наличными, расписанный по категориям
- [x] **"Итог"** - формула: выручка - безнал - терминал - бензин - зарплата - расход нал
